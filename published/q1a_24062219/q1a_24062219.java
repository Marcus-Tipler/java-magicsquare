...
public class q1a_24062219 {
    ...
    public int execVerify(String[] args) {
        if (args.length > 0) {
            ...
            if (n < 3) throw new RuntimeException("The entered value must be between 3 and 33, please try again.");
            if (n > 33) throw new RuntimeException("The entered value must be between 3 and 33, please try again.");
